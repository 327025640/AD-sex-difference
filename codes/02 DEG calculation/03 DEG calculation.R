# ============================================================================
# Script: Differential Expression Analysis for scRNA-seq data (AD vs normal,
#         female vs male) across multiple datasets.
# Author: [wzy]
# Date: 2025-03-07
# Description:
#   This script processes scRNA-seq datasets (ROSMAP and GEO) to perform
#   differential expression analysis using Seurat. It splits cells by sex
#   (Female/Male) and disease status (AD/normal) and runs FindMarkers with
#   latent variables (age, region, apoe_genotype). Results are saved
#   as RDS files.
# ============================================================================
